    ...
    <div class="post_box">
	   ...
	   <div>
	      <div class="post_box-body">
	         <p>{{post.content}}</p>
	         <p>{{post.certification}}</p>
	         <p>{{post.proof_content}}</p>
	         <p>{{post.proof_author}}</p>
	         <script language="php">
                ...
                //foreach ($hotwords as $given) {
                 //   foreach ($post_content as $manual) {
                   //     if ($given == $manual) {
                     //       array_push($common_elements, $given);
                      //  }
                  //  }
                //}
             </script>
